...
@section('content')
    ...
    <a href="{{ URL::route('seller-create-product-form') }}" class="btn btn-primary">+ Add Product</a>
    <div>
        @foreach($products as $product)
          <div class="col-xs-6 col-sm-3 placeholder">
             ...
             <a href="{{ URL::route('seller-show-product', [$product->product_id]) }}" class="btn btn-primary">More Info</a>
          </div>
        @endforeach
    </div>
@endsection()
